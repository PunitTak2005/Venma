    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      {loading ? (
        <div className="py-16 text-center">
          ...
          <p className="text-xs text-slate-400">Loading order fulfillment data...</p>
        </div>
      ) : orders.length === 0 ? (
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-12 text-center border border-slate-200 dark:border-slate-700">
          ...
          <h3 className="text-base font-bold text-slate-800 dark:text-slate-200">No orders received yet</h3>
          <p className="text-xs text-slate-400 mt-1">Customer orders containing your store products will appear here in real-time.</p>
        </div>
      ) : (
